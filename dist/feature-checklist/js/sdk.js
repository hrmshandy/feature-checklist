...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__tmp__ = __webpack_require__(3);
...
var wrapper = document.getElementById('features');

wrapper.innerHTML = __WEBPACK_IMPORTED_MODULE_1__tmp__["a" /* default */];

var status = wrapper.querySelector('.fc__status');
var lists = wrapper.querySelector('.fc-lists');
...
axios.get('/features').then(function (_ref) {
    var data = _ref.data;
    ...
    for (var item in data.items) {
        ...
        var itemStatusEl = document.createElement('div');
...
(function (d, l, id) {
    var css,
        fcss = d.getElementsByTagName(l)[0];
